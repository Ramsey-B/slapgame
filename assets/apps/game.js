...
var Thief = new Enemies('Thief', 100, 100, 0, ThiefDef, ['assets/pics/thief.png', '200vh'], 'url("assets/pics/forrest-background.jpg")', -1, 0, 0, ThiefAtt) 
var BearDef = new EDef(15,15,10,5)
var BearAtt = new EAtt('Quick Attack', 'Heavy Attack', 'Ice Ball', 10, 15, 10, 10, [1, 1, 1, 1, 2, 3])
var Bear = new Enemies('Bear', 100, 100, 0, BearDef, ['assets/pics/bear.jpg.png', '200vh'], 'url("assets/pics/grass.jpg")', -1, 0, 0, BearAtt) 
var ConeDef = new EDef(10,10,10,1)
var ConeAtt = new EAtt('Quick Attack', 'Heavy Attack', 'Arrow Rain', 10, 15, 25, 25, [0, 0, 1, 1, 1, 1, 2, 2, 3])
var Conehead = new Enemies('Cone Head', 150, 150, 0, ConeDef, ['assets/pics/conehead.png', '200vh'], 'url("assets/pics/wedding.jpg")', -1, 0, 0, ConeAtt) 
var BTDef = new EDef(15,20,15,15)
var BTAtt = new EAtt('Quick Attack', 'Heavy Attack', 'Arrow', 10, 20, 15, 15, [0, 0, 0, 1, 1, 1, 2, 3])
var BeefyThief = new Enemies('Beefy Thief', 200, 200, 0, BTDef, ['assets/pics/beefy-thief.png', '200vh'], 'url("assets/pics/forrest-background.jpg")', -1, 0, 0, BTAtt) 
var FishDef = new EDef(15,20,5,10)
var FishAtt = new EAtt('Quick Attack', 'Heavy Attack', 'Arrow', 15, 5, 0, 0, [0, 0, 0, 1, 1, 1, 2])
var Fishman = new Enemies('Fishman', 150, 150, 0, FishDef, ['assets/pics/fishman.png', '200vh'], 'url("assets/pics/temple.jpg")', -1, 0, 0, FishAtt) 
var AlienDef = new EDef(15,20,10,15)
var AlienAtt = new EAtt('Quick Attack', 'Heavy Attack', 'Laser', 10, 15, 20, 20, [0, 1, 1, 2, 3])
var Alien = new Enemies('Alien', 200, 200, 0, AlienDef, ['assets/pics/alien.png', '200vh'], 'url("ship.jpg")', -1, 0, 0, AlienAtt) 
